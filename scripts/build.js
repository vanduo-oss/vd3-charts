// Single-entry esbuild harness for @vanduo-oss/vd3-charts.
//
...
// styles.css copied to dist/vd3-charts.css.
...
async function build() {
  ...
  copyFileSync(src('styles.css'), dist('vd3-charts.css'));
  ...
  console.log(
    `Built @vanduo-oss/vd3-charts: esm + cjs; ${exportCount} export targets verified; isolation + vue-external checks passed.`,
  );
}
